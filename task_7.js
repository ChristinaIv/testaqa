...
a = $x ('//*[@class="media__link"]/section[3]/div/ul/li[1]/div/a')                    // тоже изображение на главной странице через XPath

console.log(document.querySelector("li.media-list__item.media-list__item--2"))  //изображение 2 на главной странице
a = $x ('//*[@class="media-list__item media-list__item--2"]/section[3]/div/ul/li[2]/div/a')                //  изображение 2 через XPath

console.log(document.querySelector('#orb-nav-links').querySelectorAll("li:nth-child(even)>a")) // четные разделы
div[@id="orb-nav-links"]//li[not(contains(@class, "orb-nav-hide"))][position() mod 2 = 0]/a        // через XPath

console.log(document.querySelector("h2.module__title"))          //дата
a = $x ('//*[@class="module__title"]/section[2]/h2')                                 //дата XPath